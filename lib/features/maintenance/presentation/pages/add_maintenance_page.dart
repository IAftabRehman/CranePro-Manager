...
class AddMaintenancePage extends ConsumerStatefulWidget {
  ...
  const AddMaintenancePage({super.key, this.expenseToEdit});
...
class _AddMaintenancePageState extends ConsumerState<AddMaintenancePage> {
  ...
  void initState() {
    ...
    if (widget.expenseToEdit != null) {
      ...
      _reasonController.text = widget.expenseToEdit!.description;
    ...
    try {
      if (widget.expenseToEdit != null) {
        ...
        final updatedExpense = ExpenseModel(
          ...
          operatorId: widget.expenseToEdit!.operatorId,
          category: 'Maintenance',
          amount: double.parse(_amountController.text),
          description: _reasonController.text,
          date: _selectedDate,
        );
        await ref.read(financeRepositoryProvider).updateExpense(updatedExpense);
      } else {
        // Add mode
        final expense = ExpenseModel(
          id: '',
          operatorId: 'operator_id', // Replace with real operator auth ID
          category: 'Maintenance',
          amount: double.parse(_amountController.text),
          description: _reasonController.text,
          date: _selectedDate,
  ...
  Widget build(BuildContext context) {
    ...
    return PremiumScaffold(
      appBar: AppBar(
        ...
        title: Text(
          widget.expenseToEdit != null ? 'Edit Maintenance' : 'Add Maintenance',
